        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="{{ $__url('blog-message-notices/create') }}">
              ...
              <div class="input-group input-group-sm col-xs-2 pull-right">
                <input type="text" class="form-control" placeholder="简短通知">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  <td>{{ $value->id }}</td>
                  <td>{!! $value->message->message !!}</td>
                  <td class="bg-{{ $value->color }}">{{ $value->color }}</td>
                  <td>{{ $value->topped_at }}</td>
                  <td>{{ $value->created_at }}</td>
                  <th>
                    <a href="{{ $__url('blog-message-notices/'.$value->id.'/edit') }}">
                      <i class="fa fa-edit"></i>
                    </a>
                    @if($value->id == 1)
                    <a herf="javascript:void(0);" class="js-destroy" data-url="{{ $__url('blog-message-notices/'.$value->id) }}">
