              ...
              <div class="tab-pane active" id="settings">
                <form class="form-horizontal" action="{{ mUrl('user') }}" method="POST" omsubmit="return submit();">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="oldpassword" id="inputOldPassword" placeholder="OldPassword">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="repassword" id="inputRePassword" placeholder="RePassword">
                    </div>
                  </div>
                  <div class="form-group">
